# **Проект: Производственная симуляция с многопоточностью**

## **Описание проекта**

Данный проект симулирует производственный процесс с учетом ограниченного количества работников и производственных центров, которые связаны друг с другом взвешенными ребрами. Алгоритм распределяет работников между центрами на основе их загрузки и производительности, оптимизируя производственный процесс.
